    ...
    <form action="">
        ...
        <div class="collapse" id="collapseExamples">
            <div class="card card-body">
                Para elaborar un sitio web dedicado al desarrollo de soluciones digitales y experiencias inmersivas con
                realidad virtual, debes tener en cuenta: diseño y experiencia de usuario, contenido relevante,
                tecnología adecuada, optimización CEO, responsividad, seguridad, integración con redes sociales, y
        ...
        <div>
            ...
            <p>
                <a class="btn btn-danger" data-bs-toggle="collapse" href="#collapseExampler" role="button"
                    ...
                    •De acuerdo con los objetivos del cliente ¿Cuál sería el contenido principal, que debería incluir el
                    sitio web?
                </a>
            ...
            <div class="collapse" id="collapseExampler">
                <div class="card card-body">
                    Dar a conocer su portafolio de servicios, para posicionarse en el mercado nacional como una empresa
                    líder en la creación de proyectos de realidad virtual
                    Conformar sus equipos de trabajo a través del reclutamiento de talento local, apoyando así la
                    economía del país.
        ...
        <div class="collapse" id="collapseExample2">
            <div class="card card-body">
                Es importante identificar las necesidades del cliente para el diseño del sitio web porque permite crear
                un sitio que satisfaga sus objetivos y expectativas, lo que mejora la experiencia de usuario y aumenta
                la satisfacción del cliente. Además, puede llevar un aumento en la lealtad del cliente y beneficios
        ...
        <p>
            <a class="btn btn-success" data-bs-toggle="collapse" href="#collapseExample3" role="button"
                ...
                •Realice la lectura comprensiva del documento “Requisitos del frontend” disponible en la plataforma de
                aprendizaje, en el cual se presentan, métodos de recolección de datos, herramientas para definir
        ...
        <div class="collapse" id="collapseExample3">
            <div class="card card-body">
                Los requisitos del frontend son una parte importante del proceso de desarrollo de software. El frontend
                se refiere a la parte visible de una aplicación o sitio web que los usuarios interactúan directamente.
                Los requisitos del frontend describen lo que el usuario verá y cómo interactuará con la aplicación o el
                sitio web.

                Para establecer los requisitos del frontend, es importante recopilar información sobre los usuarios y
                sus necesidades. Esto se puede hacer mediante métodos como encuestas, entrevistas, grupos focales y
                pruebas de usabilidad. Estos métodos permiten obtener información sobre lo que los usuarios necesitan y
                esperan de la aplicación o sitio web.

                Las herramientas para definir usuarios incluyen la creación de perfiles de usuario y la segmentación de
                usuarios por características demográficas y de comportamiento. Esto ayuda a comprender mejor las
                necesidades y deseos de los usuarios y permite crear una experiencia de usuario mejor y más
                personalizada.

                Los conceptos técnicos también son importantes para establecer los requisitos del frontend. Esto incluye
                entender los diferentes navegadores web y dispositivos que los usuarios pueden usar para acceder a la
                aplicación o el sitio web, así como los estándares web y las tecnologías de desarrollo como HTML, CSS y
                JavaScript.

                En resumen, para establecer los requisitos del frontend, es importante recopilar información sobre los
                usuarios y sus necesidades, definir perfiles de usuario y segmentar a los usuarios, y comprender los
        ...
        <p>
            <a class="btn btn-primary" data-bs-toggle="collapse" href="#collapseExample4" role="button"
                ...
                • ¿Cuál de las técnicas de recolección de información, considera que podría usar para conocer mejor las
                necesidades del cliente y definir las características de la solución para el caso planteado?, ¿Por qué?
            </a>

        </p>
        <div class="collapse" id="collapseExample4">
            <div class="card card-body">
                Un cuestionario bien diseñado ofrece preguntas especificas, con opciones de respuesta claramente
                definidas.
                Esta estructura estandarizada permite una recolección de datos uniforme y consistente, lo que permite la
        ...
        <p>
            <a class="btn btn-danger" data-bs-toggle="collapse" href="#collapseExample5" role="button"
                ...
                • ¿En qué partes del caso debería enfocarse la recolección de información para profundizar en su
                comprensión?
            </a>
        ...
        <div class="collapse" id="collapseExample5">
            <div class="card card-body">
                sin las técnicas de recolección de datos, estas técnicas conducen a la verificación del problema
        ...
        <div class="collapse" id="collapseExample6">
            <div class="card card-body">
                Podemos definirla con segmentación demográfica, personas, casos de uso y pruebas de usabilidad. Es
                importante considerar las necesidades, motivaciones y comportamientos de los usuarios para crear
        ...
        <div class="collapse" id="collapseExample8">
            <div class="card card-body">
                ...
                <p>
                    7)¿Qué tan importante es para usted que el sitio web se adapte a diferentes tamaños de pantalla (por
        ...
        <p>
            <a class="btn btn-dark" data-bs-toggle="collapse" href="#collapseExample9" role="button"
        ...
        <div class="collapse" id="collapseExample9">
            <div class="card card-body">
                ...
                <p>3)¿Hay algún sitio web que le guste y que sirva como referencia para lo que está buscando en su sitio
                    web?</p>
            </div>
        </div> --}}
        ...
        <form action="">
          <ul>
            ...
            <ol>6. ¿Prefiere que el sitio web tenga un diseño simple y limpio o uno más elaborado y detallado?</ol>
            <input type="radio" name="6" id="">
            <label for="a">Simple y limpio</label>
            <input type="radio" name="6" id="">
            <label for="a">Elaborado y detallado</label>
      
            <ol>7. ¿Qué tan importante es para usted que el sitio web se adapte a diferentes tamaños de pantalla (por ejemplo,
            ...
            <ol>8. ¿Qué le gustaría ver en el sition web que no se haya mencionado en las preguntas anteriores?</ol>
      
            <div class="textarea">
              <textarea type="text" name="8" id="editor" class="form-control w-full" rows="6"></textarea>
            </div>
            ...
            <div class="textarea">
              <textarea type="text" name="9" id="editor" class="form-control w-full" rows="6"></textarea>
            </div>
      
            <ol>10. ¿Hay algún sitio web que le gustey que sirva como referencia para lo que está buscando en su sitio web?
            </ol>
            <div class="textarea">
              <textarea type="text" name="10" id="editor" class="form-control w-full" rows="6"></textarea>
            </div>
